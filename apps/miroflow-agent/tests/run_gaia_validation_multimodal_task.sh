...
PY_SCRIPT="${SCRIPT_DIR}/run_gaia_validation_multimodal_task.py"
...
usage() {
  cat <<'EOF'
Usage:
  ./tests/run_gaia_validation_multimodal_task.sh --id <task_id> [options]

Required:
  --id <task_id>            GAIA multimodal task_id
